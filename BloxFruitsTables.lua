return {
    ...
    Islands = {
        World1 = {
            {Name = "Pirate Starter", CFrame = CFrame.new(1088, 41, 1442)},
            {Name = "Marine Starter", CFrame = CFrame.new(-2568, 18, 2064)},
            {Name = "Jungle", CFrame = CFrame.new(-1692, 58, 177)},
            {Name = "Pirate Village", CFrame = CFrame.new(-1131, 121, 4194)},
            {Name = "Desert", CFrame = CFrame.new(900, 19, 4195)},
            {Name = "Frozen Village", CFrame = CFrame.new(1386, 91, -1275)},
            {Name = "Marine Fortress", CFrame = CFrame.new(-4582, 23, 4118)},
            {Name = "Middle Town", CFrame = CFrame.new(-494, 17, 1527)},
            {Name = "Prison", CFrame = CFrame.new(5008, 24, 743)},
     ...
     Bosses = {
        ...
        World1 = {
            ...
            {Name = "Sky Warload", CFrame = CFrame.new(-6271, 5479, 1887)},
            {Name = "Lighting God", CFrame = CFrame.new(-7125, 5610, 111)},
